...
if(!empty($_POST["searchTerm"])){ 
    ...
    $fetchData = pg_query($conimed,"select replace(code,'.','')as\"code\",description from fix_icd10 where lower(code) like  '%".$search."%'  or upper(code) like  '%".$search."%' lower(description) like '%".$search."%' limit 10");
