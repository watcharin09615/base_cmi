...
if(!empty($_POST["searchTerm"])){ 
    ...
    $fetchData = pg_query($conimed,"select replace(code,'.','')as\"code\",description from fix_icd10 where code like binary '%".$search."%' or description like binary '%".$search."%' limit 10");
