...
$sqlnon = "select department from base inner join department on base.department = department.id_department where icd9 = '' and icd10 = '$icd10'  " or die("Error:" . mysqli_error($con));
