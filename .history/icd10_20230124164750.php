...
if(!empty($_POST["searchTerm"])){ 
    ...
    $fetchData = pg_query($conimed,"select replace(code,'.','')as\"code\",description from fix_icd10 where code like '%".$search."%' COLLATE utf8_general_ci or description like '%".$search."%' COLLATE utf8_general_ci limit 10");
