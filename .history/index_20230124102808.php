...
<head>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <!-- icd9 Sales -->
            <div class="col-12" >
              <div class="card recent-sales overflow-auto"  id="icd9_card">

                <div class="card-body">
                  <h5 class="card-title">ICD 9 </h5>

                  <table class="table table-borderless datatable" id="table_icd9">
  ...
  <!-- <script src="assets/js/jsme.js"></script> -->
  ...
  $(".form-select").datatable("change",function() {
