...
while ($row = pg_fetch_array($fetchData)) {    
    ...
    $deaprtment = "select department from base where active = '1' and icd9 = '".$row['code']."' and icd10 = '$icd10'  " or die("Error:" . mysqli_error($con));
    $resultdepart = mysqli_query($con, $deaprtment);
